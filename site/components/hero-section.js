        ...
        <div class="mx-auto max-w-content px-6 md:px-10 text-center">
          ...
          <div class="mt-20 flex flex-col md:block relative px-4 md:px-0 mx-auto max-w-5xl">
            ...
            <div class="mt-8 md:mt-0 -mb-8 md:mb-0 flex flex-col items-center gap-4 md:block md:absolute md:inset-0 w-full md:pointer-events-none z-10">
               <!-- Popup 1: Partner -->
               <div class="relative md:absolute md:top-[15%] md:right-[10%] z-10 md:z-10 will-change-transform md:pointer-events-auto" data-speed-mobile="-0.04" data-speed-desktop="-0.14">
               ...
               <!-- Popup 2: Consumer -->
               <div class="relative md:absolute md:top-[45%] md:right-[-7%] z-20 md:z-10 will-change-transform md:pointer-events-auto" data-speed-mobile="-0.12" data-speed-desktop="-0.22">
               ...
               <!-- Popup 3: Strategic -->
               <div class="relative md:absolute md:bottom-[15%] md:left-[46%] z-30 md:z-10 will-change-transform md:pointer-events-auto" data-speed-mobile="-0.18" data-speed-desktop="-0.12">
